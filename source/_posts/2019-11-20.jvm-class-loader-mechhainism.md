...
![虚拟机-类加载-ExtClassLoader-依赖](https://cdn.jsdelivr.net/gh/smile-lxy/resources@latest/images/jvm-class-load-extclass-to-top-dependent-graph.png)
![虚拟机-类加载-AppClassLoader-依赖](https://cdn.jsdelivr.net/gh/smile-lxy/resources@latest/images/jvm-class-load-appclass-to-top-dependent-graph.png)
...
![虚拟机-类加载-SPI-MySQL](https://cdn.jsdelivr.net/gh/smile-lxy/resources@latest/images/jvm-class-load-spi-mysql.png)
``` java
